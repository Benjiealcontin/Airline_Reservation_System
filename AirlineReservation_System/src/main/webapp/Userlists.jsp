                ...
                <tbody>
                    ...
                    %>
                        ...
                        <td>
                            ...
                            <a href="EditForm.jsp?ID=<%out.print(rs.getString("ID")); %>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="Delete?ID=<%out.print(rs.getString("ID")); %>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                    <% } %>
</tbody>
