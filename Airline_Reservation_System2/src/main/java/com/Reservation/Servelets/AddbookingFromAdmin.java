...
/**
 * Servlet implementation class AddbookingFromAdmin
 */
public class AddbookingFromAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddbookingFromAdmin() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (i > 0) {
			RequestDispatcher rd1 = request.getRequestDispatcher("Bookinglists.jsp");
