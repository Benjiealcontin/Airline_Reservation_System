    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a href="#" class="nav-item nav-link">Payment Lists</a>
        ...
        <div class="table-wrapper">			
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <h2 class="text-center">Payment <b>Details</b></h2>
                    </div>
                    <div class="col-sm-4">
            ...
            <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                    ...
                    %>
                        ...
                        <td><%out.print(rs.getString("Name_of_Owner")); %></td>
                        <td><%out.print(rs.getString("Card_Number")); %></td>
                        <td><%out.print(rs.getString("Date")); %></td>
                        <td><%out.print(rs.getString("CVV_code")); %></td>
                       
                        <td>
                        
                            <a href="PaymentViewDetails.jsp?ID=<%out.print(rs.getString("ID")); %>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            <a href="PaymentUpdateForm.jsp?ID=<%out.print(rs.getString("ID")); %>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="<%=request.getContextPath()%>/DeletePayment?ID=<%out.print(rs.getString("ID")); %>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                   
                        </td>
                        <td>
                        <input id="s_item3" type="checkbox"> <!-- pwede siya dungagan ug id="s_item1" id="s_item2" -->
                        </td>
