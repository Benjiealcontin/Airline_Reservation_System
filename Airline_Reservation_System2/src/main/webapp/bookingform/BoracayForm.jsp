...
<div class="container">
   <div class="signup-form">
	...
	<input type="date" class="form-control" name="departure" id="email" required="required">
        </div>        
                <div class="form-group">
            ...
            <input type="text" class="form-control" name="airport" id="pass" placeholder="Airport" required="required">
              ...
              <div class="form-group">
        		...
        		String destination=(String)session.getAttribute("boracay");   
            ...
            <select class="form-select"  name ="fair"aria-label="Default select example"  required="required">
              ...
              <div class="form-group">
				...
				String amount=(String)session.getAttribute("boracay_price");   
